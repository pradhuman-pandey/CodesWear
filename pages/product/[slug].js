...
const Post = ({addToCart, product, variants}) => {
  ...
  return (
    <section className="text-gray-600 body-font overflow-hidden bg-white shadow-2xl">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img
            alt="ecommerce"
            className="lg:w-1/2 w-full lg:h-auto px-16 object-cover object-center rounded"
            src={product.img}
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              <button onClick={addToCart(slug,1, 699, "wear the code(XL,Red)",'XL','Red')} className="flex ml-14 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">
                Add to Cart
              </button>
            ...
            <span className="pin flex flex-row gap-6 my-6">
            <input
            ...
            />
            <button onClick={CheckService} className="bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 border border-pink-700 rounded">
              Check
            </button>
          </span>
